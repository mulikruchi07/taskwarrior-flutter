...
// These functions are ignored because they are not marked as `pub`: `get_all_tasks`, `parse_datetime`, `parse_tag_query`, `task_matches_query`

Future<String> queryTask(
        {required String taskdbDirPath, required Map<String, String> query}) =>
    RustLib.instance.api
        .crateApiQueryTask(taskdbDirPath: taskdbDirPath, query: query);
